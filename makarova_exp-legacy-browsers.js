...
function ref_trainRoutineBegin(snapshot) {
  return async function () {
    ...
    ref_trainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function start_reprodRoutineBegin(snapshot) {
  return async function () {
    ...
    start_reprodComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function stop_reprod_trainRoutineBegin(snapshot) {
  return async function () {
    ...
    stop_reprod_trainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function accuracyRoutineBegin(snapshot) {
  return async function () {
    ...
    accuracyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function accuracy_specRoutineBegin(snapshot) {
  return async function () {
    ...
    accuracy_specComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function exp_start_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    exp_start_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function controlcodeRoutineBegin(snapshot) {
  return async function () {
    ...
    controlcodeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function block_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    block_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function stop_reprod_cntrlRoutineBegin(snapshot) {
  return async function () {
    ...
    stop_reprod_cntrlComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function quality_codeRoutineBegin(snapshot) {
  return async function () {
    ...
    quality_codeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ref_qualRoutineBegin(snapshot) {
  return async function () {
    ...
    ref_qualComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function stop_reprod_qltRoutineBegin(snapshot) {
  return async function () {
    ...
    stop_reprod_qltComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function quality_fdbRoutineBegin(snapshot) {
  return async function () {
    ...
    quality_fdbComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function code_quantityRoutineBegin(snapshot) {
  return async function () {
    ...
    code_quantityComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ref_quantRoutineBegin(snapshot) {
  return async function () {
    ...
    ref_quantComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function stop_reprod_qnttRoutineBegin(snapshot) {
  return async function () {
    ...
    stop_reprod_qnttComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function quantity_fdbRoutineBegin(snapshot) {
  return async function () {
    ...
    quantity_fdbComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function OSFRoutineBegin(snapshot) {
  return async function () {
    ...
    OSFComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
